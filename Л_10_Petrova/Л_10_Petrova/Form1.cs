...
namespace Л_10_Petrova
{
    public partial class Form1 : Form
    {
        ...
        void draw_gr(object sender, PaintEventArgs e)
        {
            ...
            //Мы сначала вычисляем угол "на цель", потом приращения по горизонтальной и вертикальной осям.
            //В цикле происходит измнение значения (x,y), до тех пор, пока объект "не войдет" в зону конечной точки.
            ...
            while (true)
            {
                ...
                {
                    g.DrawString("Точность: " + error.ToString(), new Font("Times New Roman", 12), new SolidBrush(Color.Black), 300, 10);
                    break;
                }
                else
                {
